  ...
  if (history.length === 0) {
    return (
      <div className="text-center py-12">
        <div className="text-base text-slate-600 mb-2">Belum ada history</div>
  ...
  return (
    <div className="space-y-3">
      <div className="flex justify-between items-center">
        <h2 className="text-base font-medium text-slate-800">History quotation</h2>
      ...
      <div className="space-y-2">
        {[...history].reverse().map((h) => (
          <div key={h.id} className="bg-white border border-slate-200 rounded-lg p-3 shadow-sm">
            ...
            <button
              onClick={() => onRestore(h)}
              className="w-full bg-slate-100 hover:bg-slate-200 border border-slate-200 text-slate-700 py-1.5 rounded-md text-xs"
            >
